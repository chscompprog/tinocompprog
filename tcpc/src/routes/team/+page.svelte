...
<h1 class="text-center font-bold text-8xl m-10 text-white drop-shadow-lg">Officers</h1>
...
<div class="flex flex-wrap ml-auto">
	<div class="easeAni relative mx-auto h-[400px] w-[400px]">
		...
		>
			<p
				class="absolute left-[13rem] top-[0rem] lg:left-[14.5rem] lg:top-[2.5rem] text-[12.5px] lg:text-md text-center overflow-auto"
			>
		...
		<img
			src={logo}
			alt="hi"
			class="absolute w-[15rem] lg:w-[17rem] rounded-full border-8 border-purple-200"
		/>
	</div>
